## fields2cover (rolling) - 2.1.1-1

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/home/sanson/.local/bin/bloom-release fields2cover -r rolling -t rolling` on `Mon, 21 Sep 2026 07:39:35 -0000`
...
## fields2cover (lyrical) - 2.1.1-1

The packages in the `fields2cover` repository were released into the `lyrical` distro by running `/home/sanson/.local/bin/bloom-release fields2cover -r lyrical -t lyrical` on `Mon, 21 Sep 2026 07:37:43 -0000`
...
## fields2cover (kilted) - 2.1.1-1

The packages in the `fields2cover` repository were released into the `kilted` distro by running `/home/sanson/.local/bin/bloom-release fields2cover -r kilted -t kilted` on `Mon, 21 Sep 2026 07:36:23 -0000`
...
## fields2cover (jazzy) - 2.1.1-1

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/home/sanson/.local/bin/bloom-release fields2cover -r jazzy -t jazzy` on `Mon, 21 Sep 2026 07:34:45 -0000`
...
## fields2cover (humble) - 2.1.1-1

The packages in the `fields2cover` repository were released into the `humble` distro by running `/home/sanson/.local/bin/bloom-release fields2cover --rosdistro humble --track humble` on `Mon, 21 Sep 2026 07:27:09 -0000`
...
## fields2cover (jazzy) - 2.1.0-1

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/home/sanson/.local/bin/bloom-release fields2cover --rosdistro jazzy --track jazzy` on `Tue, 08 Sep 2026 18:36:31 -0000`
...
## fields2cover (kilted) - 2.1.0-1

The packages in the `fields2cover` repository were released into the `kilted` distro by running `/home/sanson/.local/bin/bloom-release fields2cover --rosdistro kilted --track kilted` on `Tue, 08 Sep 2026 18:35:01 -0000`
...
- upstream repository: https://github.com/Fields2Cover/fields2cover.git
- release repository: https://github.com/ros2-gbp/fields2cover-release.git
- rosdistro version: `2.0.0-16`
- old version: `2.0.0-16`
- new version: `2.1.0-1`
...
## fields2cover (rolling) - 2.1.0-1

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/home/sanson/.local/bin/bloom-release fields2cover --rosdistro rolling --track rolling` on `Tue, 08 Sep 2026 18:31:15 -0000`
...
## fields2cover (rolling) - 2.0.0-16

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Wed, 21 May 2025 13:27:19 -0000`
...
## fields2cover (humble) - 2.0.0-12

The packages in the `fields2cover` repository were released into the `humble` distro by running `/usr/bin/bloom-release fields2cover --track humble --rosdistro humble` on `Wed, 21 May 2025 13:25:15 -0000`
...
## fields2cover (jazzy) - 2.0.0-11

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release fields2cover --track jazzy --rosdistro jazzy` on `Wed, 21 May 2025 13:23:35 -0000`
...
- release repository: https://github.com/ros2-gbp/fields2cover-release.git
- rosdistro version: `2.0.0-10`
- old version: `2.0.0-10`
- new version: `2.0.0-11`
...
## fields2cover (jazzy) - 2.0.0-10

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release fields2cover --track jazzy --rosdistro jazzy` on `Sun, 18 Aug 2024 20:22:31 -0000`
...
## fields2cover (iron) - 2.0.0-12

The packages in the `fields2cover` repository were released into the `iron` distro by running `/usr/bin/bloom-release fields2cover --track iron --rosdistro iron` on `Sun, 18 Aug 2024 20:15:54 -0000`
...
## fields2cover (iron) - 2.0.0-11

The packages in the `fields2cover` repository were released into the `iron` distro by running `/usr/bin/bloom-release fields2cover --track iron --rosdistro iron` on `Tue, 04 Jun 2024 14:16:31 -0000`
...
## fields2cover (humble) - 2.0.0-10

The packages in the `fields2cover` repository were released into the `humble` distro by running `/usr/bin/bloom-release fields2cover --track humble --rosdistro humble` on `Tue, 04 Jun 2024 14:15:16 -0000`
...
## fields2cover (rolling) - 2.0.0-14

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Tue, 04 Jun 2024 14:13:55 -0000`
...
- upstream repository: https://github.com/Fields2Cover/fields2cover.git
- release repository: https://github.com/ros2-gbp/fields2cover-release.git
- rosdistro version: `2.0.0-13`
- old version: `2.0.0-13`
...
## fields2cover (jazzy) - 2.0.0-9

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release fields2cover --track jazzy --rosdistro jazzy` on `Tue, 04 Jun 2024 14:11:39 -0000`
...
## fields2cover (rolling) - 2.0.0-13

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Tue, 14 May 2024 13:19:51 -0000`
...
## fields2cover (jazzy) - 2.0.0-8

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release fields2cover --track jazzy --rosdistro jazzy` on `Tue, 14 May 2024 04:51:57 -0000`
...
## fields2cover (jazzy) - 2.0.0-7

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release fields2cover --track jazzy --rosdistro jazzy` on `Mon, 13 May 2024 16:02:42 -0000`
...
## fields2cover (iron) - 2.0.0-10

The packages in the `fields2cover` repository were released into the `iron` distro by running `/usr/bin/bloom-release fields2cover --track iron --rosdistro iron` on `Mon, 13 May 2024 15:47:15 -0000`
...
## fields2cover (humble) - 2.0.0-9

The packages in the `fields2cover` repository were released into the `humble` distro by running `/usr/bin/bloom-release fields2cover --track humble --rosdistro humble` on `Mon, 13 May 2024 15:45:43 -0000`
...
## fields2cover (rolling) - 2.0.0-12

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Sun, 12 May 2024 08:05:45 -0000`
...
## fields2cover (iron) - 2.0.0-9

The packages in the `fields2cover` repository were released into the `iron` distro by running `/usr/bin/bloom-release fields2cover --track iron --rosdistro iron` on `Sat, 11 May 2024 16:02:06 -0000`
...
## fields2cover (jazzy) - 2.0.0-6

The packages in the `fields2cover` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release fields2cover --track jazzy --rosdistro jazzy` on `Fri, 10 May 2024 15:11:07 -0000`
...
## fields2cover (iron) - 2.0.0-8

The packages in the `fields2cover` repository were released into the `iron` distro by running `/usr/bin/bloom-release fields2cover --track iron --rosdistro iron` on `Fri, 10 May 2024 15:08:57 -0000`
...
## fields2cover (humble) - 2.0.0-8

The packages in the `fields2cover` repository were released into the `humble` distro by running `/usr/bin/bloom-release fields2cover --track humble --rosdistro humble` on `Fri, 10 May 2024 15:07:27 -0000`
...
## fields2cover (rolling) - 2.0.0-11

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Fri, 10 May 2024 15:05:38 -0000`
